                    ...
                    {!loading && (
                        ...
                        >
                            {reviews.map((rev, idx) => {
                                ...
                                const cardInner = (
                                    <div
                                        className="review-card bg-white rounded-3xl border border-gray-100 shadow-sm p-6 flex flex-col gap-4 relative transition-all duration-200 hover:shadow-lg min-w-[75vw] md:min-w-[280px]"
                                        style={{ flexShrink: 0 }}
                                    >
                                        {/* Big opening quote */}
