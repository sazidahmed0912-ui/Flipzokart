...
export const ContactUsPage: React.FC = () => {
  ...
  return (
    <div className="help-centre-page contact-page">
      <div className="help-container">
        <div className="help-card">
          <div className="bg-white">
            ...
            <section className="container mx-auto px-4 py-20 -mt-16 relative z-20 contact-us-content mobile-legal-page">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex gap-5">
                        ...
                        <div>
                          ...
                          <p className="text-[13px] md:text-lg font-bold text-dark">Mon to Sat — 9 AM to 7 PM</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-5">
                        ...
                        <div>
                          ...
                          <div className="text-[13px] md:text-lg font-bold text-dark leading-tight">
                            Contact Us <br />
