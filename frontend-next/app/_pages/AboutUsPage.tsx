...
export const AboutUsPage: React.FC = () => {
  return (
    <div className="help-centre-page about-page">
          ...
          <div className="bg-white">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                  <div className="space-y-10">
                    ...
                    <div className="flex flex-wrap gap-4 pt-4">
                      <Link href="/shop" className="bg-primary text-white px-8 py-4 rounded-2xl font-bold hover:shadow-2xl hover:-translate-y-1 transition-all flex items-center gap-2">
            ...
            <section className="container mx-auto px-4 py-12 mb-20">
              <div className="flex flex-col items-center text-center space-y-8">
                ...
                <Link href="/signup" className="bg-dark text-white px-12 py-5 rounded-[2rem] font-bold text-lg hover:bg-primary transition-all shadow-xl shadow-gray-200">
                  Create Free Account
                </Link>
              </div>
            </section>
