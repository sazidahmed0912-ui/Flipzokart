          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <SmoothReveal direction="up" delay={700} className="flex flex-col h-full">
              <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-[0_4px_12px_rgba(0,0,0,0.03)] flex flex-col h-full">
                ...
                <Link href="/admin/products" className="w-full mt-4 py-3 bg-gray-50 text-gray-700 rounded-xl text-xs font-bold hover:bg-gray-100 transition-colors block text-center">
                  View Inventory
                </Link>
              </div>
            </SmoothReveal>
          ...
          <SmoothReveal direction="up" delay={800} className="w-full">
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-[0_4px_12px_rgba(0,0,0,0.03)]">
              <div className="flex justify-between items-center mb-6">
                ...
                <Link href="/admin/orders" className="text-xs font-bold text-[#2874F0] hover:underline flex items-center gap-1">
