...
export const ProductCard: React.FC<ProductCardProps> = ({ product, priority = false }) => {
  ...
  return (
    <div className={`group bg-white rounded-lg md:rounded-xl border border-gray-100 overflow-hidden hover:shadow-lg transition-transform duration-300 transform-origin-center will-change-transform hover:scale-[1.02] md:hover:scale-[1.03] flex flex-col ${animationClass}`}>
