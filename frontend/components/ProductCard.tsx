  ...
  return (
    <div className="group bg-white rounded-lg md:rounded-xl border border-gray-100 overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
      ...
      <div className="p-2 md:p-4 flex flex-col flex-grow">
        ...
        <Link to={`/product/${product.id}`} className="font-semibold text-xs md:text-sm line-clamp-2 mb-1 md:mb-2 hover:text-primary transition-colors min-h-[32px] md:min-h-[40px] leading-tight">
          {product.name}
        </Link>
