                ...
                <div className="flex-grow flex flex-col justify-between py-2">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-6 mt-8">
                    ...
                    <div className="text-right">
                      <p className="text-3xl font-bold text-dark tracking-tighter">₹{(item.price * item.quantity).toLocaleString('en-IN')}</p>
                      <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">₹{item.price.toLocaleString('en-IN')} / unit</p>
                    </div>
                  </div>
                </div>
              </div>
