    ...
    return (
        <div className="bg-gray-50 min-h-screen py-10 px-4 md:px-8 font-sans text-gray-800">
            <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm p-8 md:p-12">
                <SmoothReveal>
                    <h1 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900 border-b pb-4">Terms and Conditions for Flipzokart</h1>
                    ...
                    <div className="prose prose-blue max-w-none text-sm md:text-base leading-relaxed text-gray-700 space-y-6">
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                <li>"Flipzokart", "we", "us", "our" refers to the Flipzokart ecommerce platform.</li>
                                <li>"User", "Customer" refers to any person accessing or purchasing from Flipzokart.</li>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                ...
                                <li>By using Flipzokart, you confirm that the information provided is accurate and complete.</li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                ...
                                <li>Flipzokart is not responsible for unauthorized access due to user negligence.</li>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                ...
                                <li>Flipzokart reserves the right to modify or discontinue products without prior notice.</li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                ...
                                <li>Flipzokart does not store card, UPI, or banking details.</li>
                        ...
                        <section>
                            ...
                            <p className="mt-2">Flipzokart reserves the right to cancel orders due to:</p>
                            <ul className="list-disc pl-5 space-y-1">
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                <li>Returns and refunds are governed by the Flipzokart Refund & Cancellation Policy.</li>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                <li>All website content, logos, designs, and software are the property of Flipzokart.</li>
                        ...
                        <section>
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                <li>Flipzokart uses third-party services including Razorpay and logistics providers.</li>
                        ...
                        <section>
                            ...
                            <p>Flipzokart shall not be liable for:</p>
                            <ul className="list-disc pl-5 space-y-1">
                        ...
                        <section>
                            ...
                            <p>Flipzokart may terminate or suspend user accounts without prior notice if Terms are violated.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>Flipzokart reserves the right to update these Terms at any time. Continued use of the platform constitutes acceptance of revised Terms.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>By accessing or using Flipzokart, you acknowledge that you have read, understood, and agreed to these Terms and Conditions.</p>
                        </section>
